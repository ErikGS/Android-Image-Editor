...
import me.mixal.edits.editor.fragment.BeautyFragment;
import me.mixal.edits.editor.fragment.BrightnessFragment;
import me.mixal.edits.editor.fragment.FilterListFragment;
import me.mixal.edits.editor.fragment.MainMenuFragment;
import me.mixal.edits.editor.fragment.RotateFragment;
import me.mixal.edits.editor.fragment.SaturationFragment;
import me.mixal.edits.editor.fragment.StickerFragment;
import me.mixal.edits.editor.fragment.crop.CropFragment;
import me.mixal.edits.editor.fragment.paint.PaintFragment;
import me.mixal.edits.editor.interfaces.OnLoadingDialogListener;
import me.mixal.edits.editor.interfaces.OnMainBitmapChangeListener;
import me.mixal.edits.editor.utils.BitmapUtils;
import me.mixal.edits.editor.utils.PermissionUtils;
import me.mixal.edits.editor.view.BrightnessView;
import me.mixal.edits.editor.view.CustomPaintView;
import me.mixal.edits.editor.view.CustomViewPager;
import me.mixal.edits.editor.view.RotateImageView;
import me.mixal.edits.editor.view.SaturationView;
import me.mixal.edits.editor.view.StickerView;
import me.mixal.edits.editor.view.TextStickerView;
import me.mixal.edits.editor.view.imagezoom.ImageViewTouch;
import me.mixal.edits.editor.view.imagezoom.ImageViewTouchBase;
import me.mixal.edits.editor.widget.RedoUndoController;
...
public class EditImageActivity extends BaseActivity implements OnLoadingDialogListener {
    ...
    private void loadImageFromFile(String filePath) {
        ...
        Disposable loadImageDisposable = loadImage(filePath)
                ...
                .doOnSuccess(bitmap -> mainMenuFragment.setMenuOptionsClickable(true))
                .doFinally(() -> loadingDialog.dismiss())
