...
public class EditCache {
    ...
    private final LinkedList<Bitmap> mCacheList = new LinkedList<>();
    ...
    private final List<ListModify> mObserverList = new ArrayList<>(2);
    ...
    public String debugLog() {
        ...
        for (int i = 0; i < mCacheList.size(); i++) {
            sb.append("{ ").append(mCacheList.get(i)).append(" }");
        }
        return sb.toString();
    }
