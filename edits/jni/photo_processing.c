...
//Java_editimage_fliter_PhotoProcessing
int Java_editimage_fliter_PhotoProcessing_nativeInitBitmap(JNIEnv* env, jobject thiz, jint width, jint height) {
	return initBitmapMemory(&bitmap, width, height);
}

//

void Java_editimage_fliter_PhotoProcessing_nativeGetBitmapRow(JNIEnv* env, jobject thiz, jint y, jintArray pixels) {
...
void Java_editimage_fliter_PhotoProcessing_nativeSetBitmapRow(JNIEnv* env, jobject thiz, jint y, jintArray pixels) {
	int cpixels[bitmap.width];
	(*env)->GetIntArrayRegion(env, pixels, 0, bitmap.width, cpixels);
	setBitmapRowFromIntegers(&bitmap, (int)y, &cpixels);
}

int Java_editimage_fliter_PhotoProcessing_nativeGetBitmapWidth(JNIEnv* env, jobject thiz) {
	return bitmap.width;
}

int Java_editimage_fliter_PhotoProcessing_nativeGetBitmapHeight(JNIEnv* env, jobject thiz) {
...
void Java_editimage_fliter_PhotoProcessing_nativeFlipHorizontally(JNIEnv* env, jobject thiz) {
	flipHorizontally(&bitmap, 1, 1, 1);
}

int Java_editimage_fliter_PhotoProcessing_nativeRotate90(JNIEnv* env, jobject thiz) {
...
void Java_editimage_fliter_PhotoProcessing_nativeApplyInstafix(JNIEnv* env, jobject thiz) {
	applyInstafix(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplyAnsel(JNIEnv* env, jobject thiz) {
	applyAnselFilter(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplyTestino(JNIEnv* env, jobject thiz) {
	applyTestino(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplyXPro(JNIEnv* env, jobject thiz) {
	applyXPro(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplyRetro(JNIEnv* env, jobject thiz) {
	applyRetro(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplyBW(JNIEnv* env, jobject thiz) {
	applyBlackAndWhiteFilter(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplySepia(JNIEnv* env, jobject thiz) {
	applySepia(&bitmap);
}
...
void Java_editimage_fliter_PhotoProcessing_nativeApplyGeorgia(JNIEnv* env, jobject thiz) {
	applyGeorgia(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplySahara(JNIEnv* env, jobject thiz) {
	applySahara(&bitmap);
}

void Java_editimage_fliter_PhotoProcessing_nativeApplyHDR(JNIEnv* env, jobject thiz) {
	applyHDR(&bitmap);
}

int Java_editimage_fliter_PhotoProcessing_nativeLoadResizedJpegBitmap(JNIEnv* env, jobject thiz, jbyteArray bytes, jint jpegSize, jint maxPixels) {
...
int Java_editimage_fliter_PhotoProcessing_nativeResizeBitmap(JNIEnv* env, jobject thiz, jint newWidth, jint newHeight) {
...
Java_editimage_fliter_PhotoProcessing_freeBeautifyMatrix(JNIEnv *env, jobject obj) {
    freeMatrix();
}

JNIEXPORT void JNICALL
Java_editimage_fliter_PhotoProcessing_handleSmoothAndWhiteSkin(JNIEnv *env, jobject obj, jobject bitmap,
...
JNIEXPORT void JNICALL
Java_editimage_fliter_PhotoProcessing_handleSmooth(JNIEnv *env, jobject obj, jobject bitmap,
                                         jfloat smoothValue) {
    AndroidBitmapInfo info;
    void *pixels;
    int ret;
...
JNIEXPORT void JNICALL
Java_editimage_fliter_PhotoProcessing_handleWhiteSkin(JNIEnv *env, jobject obj, jobject bitmap,
                                            jfloat whiteValue) {
    AndroidBitmapInfo info;
    void *pixels;
    int ret;
